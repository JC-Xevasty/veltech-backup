...
import { faArrowLeftLong, faWarning,  } from "@fortawesome/free-solid-svg-icons"
...
function PageError() {
  ...
  return (
    <>
    <Helmet>
    <title>{ process.env.REACT_APP_NAME } | 505 - SERVER ERROR</title>
  </Helmet>
    ...
    <div className="relative flex flex-col justify-between min-h-screen">
      <div className="mx-10 lg:mx-36 my-10 lg:my-15">
        <div className="flex flex-col gap-y-5 w-full lg:w-3/4 mt-5 lg:mt-20">
          <h1 className="text-[5rem] text-[#0B2653] leading-none font-grandview-bold">Unexpected Error <FontAwesomeIcon icon={ faWarning }/> </h1> 
          <h5 className="text-[2.25rem] text-[#5A5A5A] font-grandview-light pb-5">We are working on fixing the problem. Be
          <br/>back soon.</h5>
          <h1 className="text-[2.65rem] text-[#0B2653] pb-5 leading-none font-grandview-bold">505 - SERVER ERROR</h1>
