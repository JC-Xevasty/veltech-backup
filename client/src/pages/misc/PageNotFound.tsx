...
function PageNotFound() {
  ...
  return (
    ...
    <div className="flex flex-col gap-y-5 w-full lg:w-3/4 mt-5 lg:mt-20">
            <h1 className="text-[6.65rem] text-[#0B2653] leading-none font-grandview-bold">Oh no! :( </h1>
            <h5 className="text-[2.25rem] text-[#5A5A5A] font-grandview-light pb-5">The page you are looking for 
            <br/>does not exist.</h5>
            <h1 className="text-[2.65rem] text-[#0B2653] pb-5 leading-none font-grandview-bold">404 - PAGE NOT FOUND</h1>
