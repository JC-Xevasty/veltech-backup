    ...
    <Fragment>
      ...
      <div className={ `${ offset }` }>
        <main className={ `grow flex flex-col justify-start items-start gap-y-5 w-full h-full p-5 px-5` }>
          <HeaderGroup text={ `View Supplier ${ supplier?.name }` } link="/admin/accounting/suppliers" />
          ...
          <form className="flex flex-col gap-y-3 w-full">
            ...
            <div className="flex flex-col items-start justify-start gap-y-3 my-7 w-full">
            {
              contacts!.map((value: string, index: number) => (
                <div className="grid grid-cols-4 gap-x-2.5 w-full" key={ value }>
                  <InputGroup
                    id="first-name"
              ...
              <div className="grid grid-cols gap-x-2.5 w-full">
